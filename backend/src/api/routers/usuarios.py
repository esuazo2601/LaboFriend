...
@router.get(
    "/datos_token/{token}", response_description="Datos del token extraidos con éxito"
)
...
@router.post(
    "/usuario/admin", status_code=201, response_description="Permisos de administrador"
)
...
@router.post(
    "/usuario/ayudante", status_code=201, response_description="Permisos de ayudante"
)
...
@router.post(
    "/usuario/estudiante",
    status_code=201,
    response_description="Permisos de estudiante",
)
