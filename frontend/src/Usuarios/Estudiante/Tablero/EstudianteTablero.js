...
function EstudianteTablero() {
    ...
    >
       <Container>
        ...
        <div className="tablero-container">
          <NavLink to="/estudiante/cuenta" className="tablero-item">
            <FaUserAlt className="tablero-icon" />
            <span>Cuenta</span>
          </NavLink>
          <NavLink to="/estudiante/inventario" className="tablero-item">
            <FaArchive className="tablero-icon" />
            <span>Inventario</span>
          </NavLink>
          <NavLink to="/estudiante/investigaciones/personales" className="tablero-item">
          <FaUserSecret className="link-icon"/> 
            <span>Investigaciones Personales</span>
          </NavLink>
          <NavLink to="/estudiante/reservaHora" className="tablero-item">
  ...
  export default EstudianteTablero;