...
import ModalNuevoAvance from './Componentes/ModalAvance';
...
function EstudianteInvestigacion() {
    ...
    return (
        <Container>
            ...
            <Row>
                ...
                <Col>
                    <ModalNuevoAvance id = {investigacionId} onAddInvestigacion ={handleRefresh} />
                </Col>
            </Row>
...
export default EstudianteInvestigacion;